...
constexpr auto stack_size = 0x100000;
...
int main()
{
...

    {
        ...
        std::cout << "lockfree stack:   " << duration_cast<microseconds>(end - start).count() << "us" << std::endl;
    }
...

    {
        ...
        auto end = steady_clock::now();
        std::cout << "stack with locks: " << duration_cast<microseconds>(end - start).count() << "us" << std::endl;
    }
